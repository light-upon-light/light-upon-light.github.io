...
bordered lapis-and-gold panel (gold inset hairline on both the card and the
closed pill; the gold label dash on the open card only), deliberately refusing the left rule
